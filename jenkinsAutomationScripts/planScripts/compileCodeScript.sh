...
ls -al conor-git-repo/softwareProduct_calculator/src/main/java/
...
flock -x -n -E 1 conor-git-repo/softwareProduct_calculator/src/main/java/Calculator.java sh -c "javac conor-git-repo/softwareProduct_calculator/src/main/java/Calculator.java"

if [ -f conor-git-repo/softwareProduct_calculator/src/main/java/Calculator.class ]
then
